...
# Summary
For our data set we decided to calculate 5 summary information. They are individually: The total net world carbon dioxide export, The highest most recent carbon export, The lowest most recent carbon export, The country with the highest rate of carbon export growth, and the country with lowest rate of carbon export growth.
...
# Chart3
China is the fastest growing country in the world, by analyzes China’s carbon emissions to understand the country’s development relationship with it's carbon emissions.
```{r,echo=FALSE, message=FALSE,eval=TRUE}
chart3_plot
```
